...
Across successive stops, the concierge performs one of six different one-shot
actions—arrival settle, bow, escort, handshake, bashful smile, or welcome—then
returns to idle before moving again. Stay put stops automatic window movement.
