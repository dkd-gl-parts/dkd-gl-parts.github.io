...
const waybillContext = {
  ...
  salesOrderCarrierTrackingLinkHtml: (order, purpose, trackingNumber) => trackingNumber ? `<a class='sales-order-carrier-tracking' data-sales-order-tracking-link data-waybill-purpose='${purpose}'>配送状況を確認</a>` : "",
...
for (const fragment of ["sales-order-carrier-tracking-row", "data-waybill-purpose='outbound'", "配送状況を確認"]) {
  requireFragment(savedNumberHtml, fragment, `Registered waybill tracking action is missing: ${fragment}`);
}
