...
[
  ...
  ["#screen-production-search .production-detail { max-width: none; min-height: 0; padding: 8px 10px 10px; }", "manufacturing viewport-fit detail spacing"],
  ["#screen-production-search .production-image-panel { margin: 0; }", "manufacturing compact image spacing"],
  [".production-workspace { display: grid; flex: 1 1 auto;", "manufacturing workspace layout"],
  [".production-kikan-section { display: flex; flex-direction: column; min-height: 0; overflow: hidden; }", "manufacturing compatibility workspace"],
  ["#screen-production-search .detail-spec-grid { grid-template-columns: 86px minmax(0, 1fr) 86px minmax(0, 1fr); }", "manufacturing compact specification grid"],
