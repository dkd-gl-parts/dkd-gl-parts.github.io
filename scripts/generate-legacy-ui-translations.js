...
const curatedTranslations = {
  en: {
    ...
    "得意先ごとの確定価格を確認し、PDFにまとめます。": "Review customer-specific prices and prepare a PDF.",
    "出荷実績や仕入先商品を集計して出力します。": "Summarize shipment history and supplier products.",
    "← レポート": "← Reports",
    "帳票出力 / 販売価格表": "Reports / Price List",
    "得意先に現在適用される価格だけを掲載します。発行時点の品番と価格は履歴に保存されます。": "Only currently effective prices are included. Issued part numbers and prices are saved in history.",
    "出力条件": "Output Filters",
    "品番で絞り込み": "Filter by Part Number",
    "価格未設定、非公開、0円の品番はPDFに掲載しません。": "Unpriced, hidden, and zero-yen products are omitted from the PDF.",
    "掲載内容": "Included Products",
    "PDFを発行": "Issue PDF",
    "得意先を選択してください。": "Select a customer.",
    "カテゴリ・区分": "Category / Type",
    "G品番 / 純正品番": "G Part No. / OEM Part No.",
    "税抜価格": "Price Before Tax",
    "まだプレビューしていません。": "No preview yet.",
    "履歴を読み込んでいます。": "Loading history.",
    "価格表の条件": "Price List Filters",
    "G品番・純正品番・メーカー品番": "G, OEM, or Manufacturer Part No.",
    "販売価格表プレビュー": "Sales Price List Preview",
    "販売価格表の発行履歴": "Price List Issue History",
    ...
    "（更新": " (updates",
    "/ 登録済み": "/ Already registered",
    "/ 後発データを採用": "/ Later data used",
    "/ 要確認": "/ Needs review",
    "更新可能": "Update available",
    "旧データ": "Older data",
    ...
    "新しいCSVと発行履歴を作成します。監査に残す理由を選択してください。": "Create a new CSV and issuance history record. Select the reason to keep in the audit trail.",
    "再発行対象": "Reissue Target",
    "対象受注": "Order",
    "現在のB2 CSV": "Current B2 CSV",
    "発行履歴": "Issuance History",
    "再発行後も以前の履歴を保持": "Previous records remain after reissue",
    "再発行理由": "Reason for Reissue",
    "該当する理由を1つ選択してください。": "Select one applicable reason.",
    "必須": "Required",
    "再発行理由を選択": "Select a reason for reissue",
    "破損": "Damaged",
    "送り状が破損した": "The printed waybill was damaged",
    "紛失": "Lost",
    "送り状を紛失した": "The printed waybill was lost",
    "修正印刷": "Corrected Print",
    "受注修正後に作り直す": "Regenerate after correcting the order",
    "その他": "Other",
    "上記以外の理由": "A reason not listed above",
    "補足・その他の内容": "Details / Other Reason",
    "必要に応じて具体的な内容を入力": "Enter details if needed",
    "「その他」は5文字以上必須です。選択した理由と補足は発行履歴に保存されます。": "For Other, enter at least 5 characters. The selected reason and details are saved in the issuance history.",
    "同じ内容のCSVが必要な場合": "If You Need the Same CSV",
    "新しく再発行せず、現在の発行履歴から同じCSVを再ダウンロードできます。": "Download the same CSV from the current issuance history without creating a new reissue.",
    "発行履歴を確認": "View Issuance History",
    "再発行すると、新しいB2 CSVを作成して理由を記録します。": "Reissuing creates a new B2 CSV and records the reason.",
    "再発行してダウンロード": "Reissue and Download",
    "送り状破損による再発行": "Reissue due to damaged waybill",
    "送り状紛失による再発行": "Reissue due to lost waybill",
    "受注内容修正後の再印刷": "Reprint after order correction",
    "再発行理由を選択してください。": "Select a reason for reissue.",
    "「その他」の内容を5文字以上で入力してください。": "Enter at least 5 characters for Other.",
    "再発行しています...": "Reissuing...",
    "保存先を確認し、B2 CSVを再発行しています。": "Checking the save location and reissuing the B2 CSV.",
    "再発行を完了できませんでした。保存先と画面上部の案内を確認してください。": "The reissue could not be completed. Check the save location and the guidance at the top of the screen.",
    "B2 CSVを再発行しました。発行履歴に理由を保存しました。": "The B2 CSV was reissued and the reason was saved in the issuance history.",
    ...
    "「各種設定の変更」で確認できる内容": "What you can review under Change Settings",
    "ヤマトB2画面で表示される項目例です。設定値はB2契約・運用に合わせて確認してください。": "These are examples of items shown in Yamato B2. Check the values against your B2 contract and operating rules.",
    "プリンタ・送り状レイアウト": "Printer and waybill layout",
    "プリンタ選択": "Printer selection",
    "レーザー": "Laser",
    "使用用紙": "Paper",
    "A5マルチ用紙（レーザー専用）": "A5 multipart paper (laser only)",
    "テスト印字": "Test print",
    "発払い": "Prepaid",
    "関連設定": "Related settings",
    "マルチ用紙設定・印刷位置調整": "Multipart paper settings / Print position adjustment",
    "各種初期値": "Default values",
    "時間帯お届け": "Delivery time slot",
    "ご依頼主情報": "Sender information",
    "電話番号・枝番・名称": "Phone number / branch number / name",
    "品名1情報": "Item name 1 information",
    "品名コード1・品名1": "Item name code 1 / item name 1",
    "消費税率": "Consumption tax rate",
    "プリンタードライバー側": "Printer driver",
    "用紙サイズ「A5」・印刷の向き「横」": "Paper size: A5 / Orientation: Landscape",
  ...
  zh: {
    ...
    "得意先向け販売価格表": "客户销售价格表",
    "得意先ごとの確定価格を確認し、PDFにまとめます。": "核对客户适用价格并生成PDF。",
    "出荷実績や仕入先商品を集計して出力します。": "汇总出货记录和供应商商品。",
    "← レポート": "← 报表",
    "帳票出力 / 販売価格表": "报表 / 销售价格表",
    "得意先に現在適用される価格だけを掲載します。発行時点の品番と価格は履歴に保存されます。": "仅列出当前对该客户生效的价格。发行时的品号和价格会保存到历史记录。",
    "出力条件": "输出条件",
    "品番で絞り込み": "按品号筛选",
    "価格未設定、非公開、0円の品番はPDFに掲載しません。": "未定价、非公开和零日元商品不会列入PDF。",
    "掲載内容": "列出内容",
    "PDFを発行": "发行PDF",
    "得意先を選択してください。": "请选择客户。",
    "カテゴリ・区分": "类别 / 类型",
    ...
    "税抜価格": "未税价格",
    "まだプレビューしていません。": "尚未预览。",
    "履歴を読み込んでいます。": "正在读取历史记录。",
    "価格表の条件": "价格表条件",
    "G品番・純正品番・メーカー品番": "G品号、原厂品号或制造商品号",
    "販売価格表プレビュー": "销售价格表预览",
    "販売価格表の発行履歴": "价格表发行记录",
    "CSV対象 0件": "CSV目标 0 件",
    ...
    "新しいCSVと発行履歴を作成します。監査に残す理由を選択してください。": "创建新的CSV和发行记录。请选择要保留在审计记录中的原因。",
    "再発行対象": "重新发行对象",
    "対象受注": "目标订单",
    "現在のB2 CSV": "当前B2 CSV",
    "発行履歴": "发行记录",
    "再発行後も以前の履歴を保持": "重新发行后仍保留以前的记录",
    "再発行理由": "重新发行原因",
    "該当する理由を1つ選択してください。": "请选择一个符合的原因。",
    "必須": "必填",
    "再発行理由を選択": "选择重新发行原因",
    "破損": "破损",
    "送り状が破損した": "纸质运单已破损",
    ...
    "送り状を紛失した": "纸质运单已丢失",
    "修正印刷": "修正打印",
    "受注修正後に作り直す": "修正订单后重新生成",
    "その他": "其他",
    "上記以外の理由": "上述以外的原因",
    "補足・その他の内容": "补充说明／其他原因",
    "必要に応じて具体的な内容を入力": "根据需要输入具体内容",
    "「その他」は5文字以上必須です。選択した理由と補足は発行履歴に保存されます。": "选择“其他”时至少输入5个字符。所选原因和补充说明将保存到发行记录。",
    "同じ内容のCSVが必要な場合": "需要相同内容的CSV时",
    "新しく再発行せず、現在の発行履歴から同じCSVを再ダウンロードできます。": "无需重新发行，可从当前发行记录中再次下载相同的CSV。",
    "発行履歴を確認": "查看发行记录",
    "再発行すると、新しいB2 CSVを作成して理由を記録します。": "重新发行将创建新的B2 CSV并记录原因。",
    "再発行してダウンロード": "重新发行并下载",
    "送り状破損による再発行": "因纸质运单破损而重新发行",
    "送り状紛失による再発行": "因纸质运单丢失而重新发行",
    "受注内容修正後の再印刷": "订单内容修正后重新打印",
    "再発行理由を選択してください。": "请选择重新发行原因。",
    "「その他」の内容を5文字以上で入力してください。": "请为“其他”输入至少5个字符。",
    "再発行しています...": "正在重新发行...",
    "保存先を確認し、B2 CSVを再発行しています。": "正在确认保存位置并重新发行B2 CSV。",
    "再発行を完了できませんでした。保存先と画面上部の案内を確認してください。": "无法完成重新发行。请检查保存位置和页面顶部的提示。",
    "B2 CSVを再発行しました。発行履歴に理由を保存しました。": "B2 CSV已重新发行，原因已保存到发行记录。",
    ...
    "「各種設定の変更」で確認できる内容": "可在“更改各项设置”中确认的内容",
    "ヤマトB2画面で表示される項目例です。設定値はB2契約・運用に合わせて確認してください。": "以下是雅玛多B2画面中显示的项目示例。请根据B2合同和实际操作确认设置值。",
    "プリンタ・送り状レイアウト": "打印机和运单布局",
    "プリンタ選択": "打印机选择",
    "レーザー": "激光打印机",
    "使用用紙": "使用纸张",
    "A5マルチ用紙（レーザー専用）": "A5多联纸（激光打印机专用）",
    "テスト印字": "测试打印",
    "発払い": "预付",
    "関連設定": "相关设置",
    "マルチ用紙設定・印刷位置調整": "多联纸设置／打印位置调整",
    "各種初期値": "各项初始值",
    "時間帯お届け": "到货时间段",
    "ご依頼主情報": "发件人信息",
    "電話番号・枝番・名称": "电话号码／分机号／名称",
    "品名1情報": "品名1信息",
    "品名コード1・品名1": "品名代码1／品名1",
    "消費税率": "消费税率",
    "プリンタードライバー側": "打印机驱动程序",
    "用紙サイズ「A5」・印刷の向き「横」": "纸张尺寸“A5”／打印方向“横向”",
    "うまく進まない場合": "无法继续时",
