...
const curatedTranslations = {
  en: {
    ...
    "ヤマト画面で検索を続ける": "Continue search in Yamato",
    ...
    "セッション切れです。再ログインして手順2から続けてください。": "Your session has expired. Sign in again, then continue from step 2.",
    ...
    "ヤマト画面を開きました。ログイン後、D-CATSへ戻って手順2を押してください。": "The Yamato page is open. After signing in, return to D-CATS and use step 2.",
  ...
  zh: {
    ...
    "ログイン画面に戻る": "再次显示登录页面",
    "セッション切れです。再ログインして手順2から続けてください。": "会话已过期。请重新登录，然后从步骤2继续。",
    ...
    "ヤマト画面を開きました。ログイン後、D-CATSへ戻って手順2を押してください。": "雅玛多页面已打开。登录后请返回D-CATS并执行步骤2。",
