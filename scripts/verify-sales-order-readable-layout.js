...
for (const fragment of [
  ...
  ".sales-order-detail-overview-grid .sales-order-shipping-schedule { grid-column: 2; grid-row: 2;",
  ".sales-order-detail-overview-grid .sales-order-address dl { grid-column: 3; grid-row: 2;",
