...
for (const fragment of [
  ...
  ".sales-order-list-number { overflow: visible; font-size: 16px;",
  ".sales-order-list-row { grid-template-columns: 22px minmax(0, 1fr);",
  "min-height: 82px; padding: 8px 10px;",
  ".sales-order-list-customer { overflow: hidden; margin-top: 1px; font-size: 14px;",
