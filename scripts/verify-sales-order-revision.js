...
assert.equal(context.salesOrderRevisionEffectiveUnitPrice(coreRequired),12500);
assert(context.salesOrderRevisionCoreChoiceHtml(coreRequired,0).includes('請求済み・返却不要'));
