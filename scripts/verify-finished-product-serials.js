...
assert(/@media\s+print\s*{[\s\S]*?\.serial-label\s*{[^}]*transform:\s*translateY\(1\.5mm\)/i.test(printCss), "finished-label outer border is not offset below the printer's clipped top edge");
