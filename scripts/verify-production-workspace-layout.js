...
requireFragment(app, 'vehicle_info_button: "Vehicles"', "compact English vehicle action");
requireFragment(app, "detail-vehicle-grid detail-vehicle-maker-grid", "vehicle maker row class");
[
...
[
  ...
  ".production-core-meta { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr));",
  ".production-core-meta .production-kv + .production-kv { grid-template-columns: minmax(48px, auto) minmax(0, 1fr); }",
  ".production-core-meta .production-kv div { min-width: 0; white-space: normal; overflow-wrap: anywhere; }",
