...
[
  ...
  "#screen-production-search .ac-part-row-with-action { grid-template-columns: 100px minmax(0, 1fr); }",
  "#screen-production-search .ac-part-label { font-size: 12px; white-space: nowrap; }",
  "#screen-production-search .ac-part-value-with-action .ac-part-value-text { flex: 1 1 auto; min-width: 0; white-space: nowrap;",
