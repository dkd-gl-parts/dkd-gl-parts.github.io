...
const productReturnStart = source.indexOf("function returnFromProductSearch()");
...
if (productReturnStart < 0 || productReturnEnd < productReturnStart ||
  ...
  throw new Error("sales management must preserve its in-memory search view and return directly to the authenticated menu");
}
